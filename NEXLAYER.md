...
**Live:** [https://relaxed-weasel-peertube.cloud.nexlayer.ai](https://relaxed-weasel-peertube.cloud.nexlayer.ai)  
...
**peertube** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
application:
  ...
  pods:
  - name: app
    image: mirror.gcr.io/chocobozzz/peertube:production-bookworm
    path: /
    servicePorts:
    - 9000
    vars:
      PEERTUBE_DB_HOSTNAME: postgres.pod
      PEERTUBE_DB_USERNAME: peertube
      PEERTUBE_DB_PASSWORD: ${POSTGRES_PASSWORD}
      PEERTUBE_WEBSERVER_HOSTNAME: relaxed-weasel-peertube.cloud.nexlayer.ai
      PEERTUBE_ADMIN_EMAIL: "admin@relaxed-weasel-peertube.cloud.nexlayer.ai"
      PEERTUBE_SECRET: "a1b2c3d4e5f6a1b2c3d4"
      PEERTUBE_SMTP_FROM: "peertube@relaxed-weasel-peertube.cloud.nexlayer.ai"
      PEERTUBE_REDIS_HOSTNAME: redis.pod
    volumes:
    - name: peertube-data
      mountPath: /data
      size: 20Gi
